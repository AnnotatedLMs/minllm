#!/usr/bin/env python3
"""
Training script for Llama 3 models.

Entry point flow:
1. Parse command line arguments for config path
2. Load training configuration with Llama 3 specific model config
...
4. Build Llama 3 model from config
...
def main(trainer_config: core.TrainerConfig) -> None:
    ...
    model = llama3.Llama3(trainer_config.llm)
