...
class TestKVCache:
    ...
    @pytest.fixture
    def cache(self) -> kv_cache.KVCache:
        """Create a KV cache instance."""
        return kv_cache.KVCache(
            batch_size=2,
            max_seq_length=100,
            n_kv_heads=4,
            head_dim=64,
    ...
    def test_cache_initialization(self, cache: kv_cache.KVCache) -> None:
    ...
    def test_cache_update_single_token(self, cache: kv_cache.KVCache) -> None:
        ...
        # Update cache
        cached_k, cached_v = cache.update(start_pos=0, xk=xk, xv=xv)
    ...
    def test_cache_update_sequence(self, cache: kv_cache.KVCache) -> None:
        ...
        cached_k1, cached_v1 = cache.update(start_pos=0, xk=xk1, xv=xv1)
        ...
        cached_k2, cached_v2 = cache.update(start_pos=10, xk=xk2, xv=xv2)
    ...
    def test_cache_incremental_generation(self, cache: kv_cache.KVCache) -> None:
        ...
        for pos in range(20):
            ...
            cached_k, cached_v = cache.update(start_pos=pos, xk=xk, xv=xv)
    ...
    def test_cache_reset(self, cache: kv_cache.KVCache) -> None:
        ...
        cache.update(start_pos=0, xk=xk, xv=xv)
    ...
    def test_cache_different_dtypes(self) -> None:
        ...
        for dtype in [torch.float16, torch.bfloat16, torch.float32]:
            cache_instance = kv_cache.KVCache(
                batch_size=1,
                max_seq_length=10,
                n_kv_heads=2,
                head_dim=32,
            ...
            cached_k, cached_v = cache_instance.update(0, xk, xv)
